...
var Task = function (_React$Component) {
	...
	_createClass(Task, [{
		...
		value: function componentDidMount() {
			...
			this.state.tagList.push(this.state.tags);
		}
	}, {
		key: 'render',
		value: function render() {
			...
			var taskTags = void 0;
			taskTags = this.state.tagsList.concact(this.state.tags);
...
//# sourceMappingURL=0.3dc76e358883cf94b70b.hot-update.js.map