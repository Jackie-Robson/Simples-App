...
var Task = function (_React$Component) {
	...
	function Task(props) {
		...
		_this.saveTags = _this.saveTags.bind(_this);
	...
	_createClass(Task, [{
		...
		value: function saveTags() {
			this.state.tagsList.concat(this.props.tags.tags, this.state.tagsList);
		}
	}, {
		key: 'handleChange',
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'ul',
					null,
					this.state.tagsList.map(function (tag, i) {
						return _react2.default.createElement(
							'li',
							{ key: i },
							_react2.default.createElement(
...
//# sourceMappingURL=0.9d31cdf4f345a8981be9.hot-update.js.map