...
function NewTaskWrapper(WrappedComponent) {

	return function (_React$Component2) {
		_inherits(NewTaskWrapper, _React$Component2);

		function NewTaskWrapper(props) {
			_classCallCheck(this, NewTaskWrapper);

			return _possibleConstructorReturn(this, (NewTaskWrapper.__proto__ || Object.getPrototypeOf(NewTaskWrapper)).call(this, props));
		}

		_createClass(NewTaskWrapper, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				console.log('HIGHER ORDER MOFO');
			}
		}, {
			key: 'render',
			value: function render() {
...
//# sourceMappingURL=0.fdd677a223a0ca961140.hot-update.js.map