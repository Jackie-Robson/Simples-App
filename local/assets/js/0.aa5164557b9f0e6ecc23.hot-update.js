		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					null,
					'Task:',
					_react2.default.createElement('input', { placeholder: 'Task Title', autocomplete: 'off', name: 'title', type: 'text', onChange: this.handleChange, value: this.state.title })
				),
				_react2.default.createElement(
					'label',
					null,
					'Task Objective:',
					_react2.default.createElement('input', { placeholder: 'Task objective', autocomplete: 'off', type: 'text', name: 'goal', onChange: this.handleChange, value: this.state.goal })
				),
				_react2.default.createElement(
					'button',
...
//# sourceMappingURL=0.aa5164557b9f0e6ecc23.hot-update.js.map