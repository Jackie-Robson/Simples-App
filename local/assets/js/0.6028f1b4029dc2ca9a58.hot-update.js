		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					null,
					'Task:',
					_react2.default.createElement('input', { placeholder: 'Task Title', 'auto-complete': 'off', name: 'title', type: 'text', onChange: this.handleChange, value: this.state.title })
				),
				_react2.default.createElement(
					'label',
					null,
					'Task Objective:',
					_react2.default.createElement('input', { placeholder: 'Task objective', 'auto-complete': 'off', type: 'text', name: 'goal', onChange: this.handleChange, value: this.state.goal })
				),
				_react2.default.createElement(
					'button',
...
//# sourceMappingURL=0.6028f1b4029dc2ca9a58.hot-update.js.map